...
- **Реально запускай параллельных агентов**, не имитируй.
- **Создавай файлы в `analysis/`** — не описывай «я бы создал».
- **Ключевое открытие**: «нет личности» должно быть донесено чётко.
