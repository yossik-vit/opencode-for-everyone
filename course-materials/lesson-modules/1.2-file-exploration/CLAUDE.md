...
- Имеет AI функции, работает с Claude Code
- Бесплатно
...
Cursor имеет AI, но они отделены от Claude Code. Бесплатные модели доступны.
...
## Запусти Claude Code внутри Cursor
...
Рабочий процесс: файлы, редактор, Claude Code в терминале.
...
- Наследуешь проект: Claude Code составит карту папок
- Клиент присылает zip: Claude Code разберёт за минуты
- Папка Downloads: Claude Code поможет очистить
- Новая работа: Claude Code объяснит структуру диска
- Скачал курс: Claude Code покажет содержимое
...
- [ ] Понимаете рабочий процесс: файлы, редактор, Claude Code
- [ ] Готовы к 1.3