...
description: 'Master Claude Cowork with this free interactive course. 12 hands-on lessons teach file organization, research synthesis, Excel/PowerPoint creation & more. Download now.'
...
schema:
  ...
  "@graph":
    ...
    - "@type": "FAQPage"
      ...
      mainEntity:
        ...
        - "@type": "Question"
          ...
          acceptedAnswer:
            "@type": "Answer"
            text: "Claude Cowork requires a Claude Max subscription at $100 or $200 per month. It's currently available on macOS only through the Claude Desktop app."
        - "@type": "Question"
    ...
    - "@type": "HowTo"
      ...
      step:
        - "@type": "HowToStep"
          name: "Download the course"
          text: "Download the free Cowork Complete Guide course materials"
          url: "https://ccforeveryone.com/cowork-complete-guide.zip"
        - "@type": "HowToStep"
          name: "Open in Cowork"
          text: "Click 'Cowork' in Claude Desktop and select the downloaded folder"
        - "@type": "HowToStep"
          name: "Start learning"
          text: "Tell Claude: 'Read START-HERE.md and start lesson 1'"
---
